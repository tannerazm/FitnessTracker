...
const { getAllActivities, createActivity, getActivityByName, updateActivity, getActivityById, getAllPublicRoutines, getPublicRoutinesByActivity } = require("../db");
...
router.get('/:activityId/routines', async (req, res, next) => {
    try {
        ...
        const _publicActivity = await getPublicRoutinesByActivity({id: req.params.activityId})
